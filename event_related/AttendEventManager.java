 ...
 * An attendee manager.
 * <p>
 * A manager that stores the relationship between iUser and Events
 */
public class AttendEventManager implements iUserEventManager {
    ...
    /**
     * Adds the given event to the user's list of signed up events.
     *
     * @param user  the given user
     * @param event the given event
     */
    ...
    /**
     * Returns true if and only if the given attendee exists, otherwise return false.
     *
     * @param attend the given attendee
     * @return true if and only if the given attendee exists, otherwise return false.
     */
    private boolean userExists(iUser attend) {
        return userToEvent.containsKey(attend);
    }
